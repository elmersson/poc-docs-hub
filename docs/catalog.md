...
|---|---|---|---|---|---|
| [docs-hub](teams/team-platform/docs-hub/index.md) | documentation | [team-platform](teams/team-platform/index.md) | [shop-frontend](teams/team-frontend/shop-frontend/index.md), [orders-service](teams/team-checkout/orders-service/index.md), [payments-service](teams/team-payments/payments-service/index.md), [inventory-service](teams/team-fulfillment/inventory-service/index.md), [shared-contracts](teams/team-platform/shared-contracts/index.md) | `docs-mcp` | - |
...
graph LR
  ...
  docs_hub["docs-hub<br/><i>team-platform</i>"]
  ...
  docs_hub --> shop_frontend
  docs_hub --> orders_service
  docs_hub --> payments_service
  docs_hub --> inventory_service
  docs_hub --> shared_contracts
```

## APIs and their consumers

- `docs-mcp`: provided by [docs-hub](teams/team-platform/docs-hub/index.md); consumed by none recorded
